...
<div id="wrap">
  ...
  <footer id="copyright-wrap" class="clear">
    <div id="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <a href="<?php print $front_page; ?>"><?php print $site_name; ?></a>. <?php print t('Developed at'); ?>  <a href="http://www.kytalabs.com" title="Kyta Labs" target="_blank">Kyta Labs</a>.</div>
  </footer>
</div>
